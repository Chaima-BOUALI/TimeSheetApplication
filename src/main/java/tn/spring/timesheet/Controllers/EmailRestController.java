...
import tn.spring.timesheet.config.MyConstants;
...
public class EmailRestController {
    ...
    public String sendSimpleEmail() {
        ...
        message.setSubject("Dear Mr Ghassen");
        message.setText("Check the newest Publications on our news feed don't forget to leave a comment");
